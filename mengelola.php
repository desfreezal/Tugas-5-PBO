...
<body>
      <div class="container">
        <h2 class="text-center text-white" >INPUT DATA MAHASISWA</h2>
        <br>
        <form method="POST" action="proses.php" class="font-weight-bold">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nim" class="form-control" id="Nim" required value="<?php echo $nim; ?>">
                </div>
            </div>

            <!--Form Nama Mahasiswa-->
            <div class="mb-3 row">
                <label for="Namamhs" class="col-sm-2 col-form-label text-white">Nama Mahasiswa</label>
                <div class="col-sm-10">
                    <input type="text" name="namamhs" class="form-control" id="Namamhs" required value="<?php echo $namamhs; ?>">
                </div>
            </div>

            <!--Form Jenis Kelamin-->
            <div class="mb-3 row">
                <label for="Jeniskelamin" class="col-sm-2 col-form-label text-white">Jenis Kelamin</label>
                <div class="col-sm-10">
            ...
            <!--Form prodi-->
            <div class="mb-3 row">
                <label for="prodi" class="col-sm-2 col-form-label text-white">Prodi</label>
                <div class="col-sm-10">
            ...
            <!--Form Foto Mahasiswa-->
            <div class="mb-3 row">
                <label for="Foto" class="col-sm-2 col-form-label text-white">Foto Mahasiswa</label>
                <div class="col-sm-10">
